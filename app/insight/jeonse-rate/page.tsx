        ...
        {!data ? (
          ...
          <>
            ...
            <p className="guide-summary">
              ...
              전세가 각각 3건 이상 있었고 매매 중간값이 1억원 이상인 곳을 비교했더니, 부산은 {data.groupCount["부산"]}곳의 전세가율
            ...
            <section className="brief-section">
              ...
              <p className="complex-commentary">
                ...
                각각 중간값을 구한 뒤 나눴습니다. 거래가 적으면 한두 건이 숫자를 크게 흔들기 때문에 매매·전세 각 3건 이상인 곳만 넣었고, 매매 1억원 미만 초소형 주택은 뺐습니다. 해제된 거래는 뺐습니다. 실거래 자료에는 신규 계약과 갱신 계약이

...
export const metadata: Metadata = {
  title: "사이트 소개 | 부울산 아파트 실거래",
  description: "부울산 아파트 실거래가 서비스 소개 — 어떤 데이터를 어떻게 보여주는지 안내합니다.",
};
  ...
  return (
    <div className="wrap static-page">
      ...
      <section>
        <h2>부울산 아파트 실거래란?</h2>
        <p>
          부울산 아파트 실거래는 부산광역시 16개 구·군과 울산광역시 5개 구·군의 아파트 매매·전세·월세
          실거래가 정보를 한눈에 볼 수 있도록 만든 무료 정보 서비스입니다. 지역별 거래 현황과 가격
          흐름을 쉽고 빠르게 확인할 수 있도록 하는 것을 목표로 합니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          표시되는 지역 경계는 실제 행정구역과 다를 수 있는 단순화된 개념도입니다.
        </p>
      </section>
      ...
      <section>
        <h2>이런 기능을 제공합니다</h2>
        <p>
          매매·전세·월세 탭 전환, 오늘/최근 7일 실거래 모아보기, 구 → 동 → 단지 순서의 상세
          탐색, 단지명·동 이름 검색, 가격순·최신순 정렬, 특정 단지의 최근 6개월 가격 추이 그래프
